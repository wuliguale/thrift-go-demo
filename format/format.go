...
type FormatData interface {
  ...
  // Parameters:
  //  - Data
  Hello(ctx context.Context, data *Data) (r *Data, err error)
}
...
// Parameters:
//  - Data
func (p *FormatDataClient) Hello(ctx context.Context, data *Data) (r *Data, err error) {
  var _args2 FormatDataHelloArgs
  _args2.Data = data
  var _result3 FormatDataHelloResult
  if err = p.Client_().Call(ctx, "hello", &_args2, &_result3); err != nil {
    return
  }
...
func NewFormatDataProcessor(handler FormatData) *FormatDataProcessor {
  ...
  self4.processorMap["do_format"] = &formatDataProcessorDoFormat{handler:handler}
  self4.processorMap["hello"] = &formatDataProcessorHello{handler:handler}
return self4
}
...
type formatDataProcessorHello struct {
  handler FormatData
}

func (p *formatDataProcessorHello) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := FormatDataHelloArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
  ...
  iprot.ReadMessageEnd()
  result := FormatDataHelloResult{}
var retval *Data
  var err2 error
  if retval, err2 = p.handler.Hello(ctx, args.Data); err2 != nil {
...
// Attributes:
//  - Data
type FormatDataHelloArgs struct {
  Data *Data `thrift:"data,1" db:"data" json:"data"`
}

func NewFormatDataHelloArgs() *FormatDataHelloArgs {
  return &FormatDataHelloArgs{}
}

var FormatDataHelloArgs_Data_DEFAULT *Data
func (p *FormatDataHelloArgs) GetData() *Data {
  if !p.IsSetData() {
    return FormatDataHelloArgs_Data_DEFAULT
  }
return p.Data
}
func (p *FormatDataHelloArgs) IsSetData() bool {
  return p.Data != nil
}

func (p *FormatDataHelloArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *FormatDataHelloArgs)  ReadField1(iprot thrift.TProtocol) error {
  p.Data = &Data{}
  if err := p.Data.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Data), err)
  }
...
func (p *FormatDataHelloArgs) Write(oprot thrift.TProtocol) error {
...
func (p *FormatDataHelloArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("data", thrift.STRUCT, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:data: ", p), err) }
  if err := p.Data.Write(oprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.Data), err)
...
func (p *FormatDataHelloArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("FormatDataHelloArgs(%+v)", *p)
}

// Attributes:
//  - Success
type FormatDataHelloResult struct {
  Success *Data `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewFormatDataHelloResult() *FormatDataHelloResult {
  return &FormatDataHelloResult{}
}

var FormatDataHelloResult_Success_DEFAULT *Data
func (p *FormatDataHelloResult) GetSuccess() *Data {
  if !p.IsSetSuccess() {
    return FormatDataHelloResult_Success_DEFAULT
  }
return p.Success
}
func (p *FormatDataHelloResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *FormatDataHelloResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *FormatDataHelloResult)  ReadField0(iprot thrift.TProtocol) error {
  p.Success = &Data{}
  if err := p.Success.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
  }
...
func (p *FormatDataHelloResult) Write(oprot thrift.TProtocol) error {
...
func (p *FormatDataHelloResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := p.Success.Write(oprot); err != nil {
...
func (p *FormatDataHelloResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("FormatDataHelloResult(%+v)", *p)
}
